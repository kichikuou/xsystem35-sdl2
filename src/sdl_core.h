...
extern void sdl_drawImage16_fromData(cgdata *cg, int x, int y, int w, int h, int brightness);
extern void sdl_drawImage24_fromData(cgdata *cg, int x, int y, int w, int h, int brightness);
