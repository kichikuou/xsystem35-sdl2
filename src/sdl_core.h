...
extern void sdl_drawImage8_fromData(cgdata *cg, int x, int y, int sprite_color);
extern void sdl_drawImage16_fromData(cgdata *cg, int x, int y, int brightness, bool alpha_blend);
extern void sdl_drawImage24_fromData(cgdata *cg, int x, int y, int brightness);
